...
def main():
  ...
  if lang_to_merge == "en":
    mergewith = path.dirname(__file__) + "/../text/other-psp-r11-en/init.bin.utf8.txt"
    saveas = path.dirname(__file__) + "/../text/other-psp-r11-en/init.bin.utf8.txt"
    ...
    mergewith = path.dirname(__file__) + "/../text/other-psp-r11-cn/init.bin.utf8.txt" #CN
    saveas = path.dirname(__file__) + "/../text/other-psp-r11-cn/init.bin.utf8.txt"
    tips_start = 7090
  else:
    raise Exception()
